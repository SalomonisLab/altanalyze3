...
import isoform_junctions as junc
import isoform_matrix as iso
import isoform_ratios as isor
import isoform_translation as isot
import gff_process as gff_process
...
def import_metadata(metadata_file):
    ...
    for _, row in metadata.iterrows():
        ...
        sample_dict[uid].append({
            ...
            'matrix': row['matrix'], 
            'library': row['library'], 
            'reverse': row['reverse'].strip().lower() == 'true',
            'groups': row['groups']
        })
    return sample_dict
...
def process_samples(sample_dict, ensembl_exon_dir, barcode_sample_dict):
    ...
    for uid, samples in sample_dict.items():
        ...
        combined_samples[uid] = combined_adata
...
process_samples(sample_dict, ensembl_exon_dir, barcode_sample_dict)
...
gff_gencode = '/Users/saljh8/Dropbox/Revio/Apharesis-Sequel2/ND167_Iso-Seq/PacBio/Accessory/AltgffAnalyze3/gencode.v45.annotation.gff3'
...
gff_files = [gff_gencode,gff_RefSeq,gff_GTEx]

for sam in sample_metadata:
    gff_files.append(sam.gff())
    
for sam in sample_metadata:
    junc.exportJunctionMatrix(sam.matrix(), ensembl_exon_dir, sam.gff(), barcode_clusters=barcode_sample_dict[sam.library()],rev=sam.rev_state())
...
if healthy_junction_counts:
    ...
    nd251_1_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_251_1, barcode_clusters=barcode_sample_dict['WF40_ND21-251_HSC_3k'],rev=True)
    ...
    nd251_2_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_251_2, barcode_clusters=barcode_sample_dict['WF40_ND21-251_HSC_3k'],rev=True)
    ...
    am72_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_am72, barcode_clusters=barcode_sample_dict['AM72-N-0206_CD34'],rev=True)
    ...
    wf83_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_wf83, barcode_clusters=barcode_sample_dict['WF83-N-0215_CD34'],rev=True)
    ...
    bm71_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_bf71, barcode_clusters=barcode_sample_dict['BF71-N-0421_CD34'],rev=True)
    ...
    p5801_mds_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_5801M_pre,barcode_clusters=barcode_sample_dict['WM71-0121-5801_CD34'],rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/5801-MDS/MDS-post/isoforms_seurat'
    p5801_mds_post_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_5801M_post,barcode_clusters=barcode_sample_dict['MDS5801-postHMA_CD34'],rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/5801-MDS/AML/run1/isoforms_seurat'
    p5801_aml_adata_1 = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_5801A_pre1,barcode_clusters=barcode_sample_dict['MDS5801-preVEN_342']rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/5801-MDS/AML/run2/isoforms_seurat'
    p5801_aml_adata_2 = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_5801A_pre2,barcode_clusters=barcode_sample_dict['MDS5801-preVEN_342']rev=True,)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/5801-MDS/AML-therapy/isoforms_seurat'
    p5801_aml_therapy_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_5801A_therapy,barcode_sample_dict['MDS5801-1229IR_CD34'],rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/5801-MDS/AML-post/isoforms_seurat'
    p5801_aml_post_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_5801A_post,barcode_clusters=barcode_sample_dict['MDS5801R-341'],rev=True)

    p5801_aml_adata_1 = ad.read_h5ad('5801-AML-1.h5ad')
    p5801_aml_adata_2 = ad.read_h5ad('5801-AML-2.h5ad')
    nd251_adata = ad.concat([nd251_1_adata, nd251_2_adata], axis=0, join='outer')
    ...
    am75_post_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_source=gff_am75M_post,barcode_clusters=barcode_sample_dict['Y5116'],rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/AM75-MDS/pre/isoforms_seurat'
    am75_pre_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_source=gff_am75M_pre,barcode_clusters=barcode_sample_dict['Y1258'],rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/AM75-MDS/on/isoforms_seurat'
    am75_on_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_source=gff_am75M_therapy,barcode_clusters=barcode_sample_dict['Y1607'],rev=True)
    ...
    wf78_post_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_source=gff_wf78M_post,barcode_clusters=barcode_sample_dict['Y1737'],rev=True)

    matrix_path = '/Users/saljh8/Dropbox/Revio/MDS-Revio/WF78-MDS/pre/isoforms_seurat'
    wf78_pre_adata = junc.exportJunctionMatrix(matrix_path,ensembl_exon_dir,gff_source=gff_wf78M_pre,barcode_clusters=barcode_sample_dict['Y1493'],rev=True)
    ...
    # combine assembled h5ad and export results - memory intensive - just combine the original exported files instead
...
if integrate_healthy_malignant_isoforms:
    ...
    # Produce an junction counts h5ad for the BM27 capture
    ...
    hsc_nd167_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_167h, barcode_clusters=barcode_sample_dict['WM35_ND20-167__HSC_3k'])
    ...
    mpp_nd167_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_167m, barcode_clusters=barcode_sample_dict['WM35_ND20-167__MPP_3k'])
    ...
    lmpp_nd167_adata = junc.exportJunctionMatrix(matrix_path, ensembl_exon_dir, gff_167l, barcode_clusters=barcode_sample_dict['WM35_ND20-167__LMPP_3k'])
    ...
    matrix_path = '/Users/saljh8/Dropbox/Revio/Young-Healthy-Revio/PacBio/WM34/isoforms_seurat'
    wm34_adata = isor.exportConsensusIsoformMatrix(matrix_path,isoform_association_path,gff_source=gff_wm34,barcode_clusters=barcode_sample_dict['WM34_CD34'],rev=True)
