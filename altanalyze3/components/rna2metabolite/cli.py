"""Command-line interface for rna2metabolite (AML metabolite imputation from RNA).

Subcommands:
    model-info      print bundle metadata
    predict-csv     impute metabolites from a samples-by-gene CSV/TSV
    predict-h5ad    impute metabolites from an h5ad (optionally grouped into pseudobulks)
"""
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="rna2metabolite")
