...
IN_PATH = PROCESSED / "biochem_delta_matrix.parquet"
OUT_TSV = PROCESSED / "biochem_multitask_instances.tsv"
OUT_PARQUET = PROCESSED / "biochem_multitask_instances.parquet"
OUT_SCHEMA = PROCESSED / "biochem_multitask_schema.json"
...
def main() -> int:
    ...
    schema = {
        "task_map": TASK_MAP,
        "categorical_columns": ["family_class", "reference_source", "change_class", "task"],
