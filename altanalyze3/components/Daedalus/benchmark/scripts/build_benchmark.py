...
DATA_INGEST = DAEDALUS / "data_ingest" / "data" / "interim"
BENCHMARK_DATA = DAEDALUS / "benchmark" / "data"

ISOFORM_FEATURES = DATA_INGEST / "uniprot_isoform_features.tsv"
ISOFORM_PROTEINS = DATA_INGEST / "uniprot_isoform_proteins.tsv"
TRAFFICKING_FEATURES = DATA_INGEST / "uniprot_isoform_trafficking_features.tsv"
ESM_EMBEDDINGS = DATA_INGEST / "uniprot_isoform_esm2_t30_embeddings.parquet"
LOCALIZATION_PROBS = DATA_INGEST / "uniprot_isoform_localization_probs.tsv"
CANONICAL_PM_EVIDENCE = DATA_INGEST / "uniprot_canonical_pm_evidence.tsv"
# Legacy phase_d benchmark file (gene-split assignments) — archived; if absent
# we fall back to deterministic hash-based splits.
EXISTING_BENCH = DAEDALUS / "archive" / "_legacy_phase_d_benchmark_instances.parquet"

OUT_PARQUET = BENCHMARK_DATA / "uniprot_isoform_benchmark_instances.parquet"
OUT_TSV = BENCHMARK_DATA / "uniprot_isoform_benchmark_instances.tsv"
OUT_SCHEMA = BENCHMARK_DATA / "uniprot_isoform_benchmark_schema.json"
OUT_SUMMARY = BENCHMARK_DATA / "uniprot_isoform_benchmark_summary.tsv"
