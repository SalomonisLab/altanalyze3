...
Outputs:
    data_ingest/data/interim/uniprot_localization_classifier.pt
    data_ingest/data/interim/uniprot_isoform_localization_probs.tsv
"""
...
CANONICAL_EMB_PARQUET = DATA_DIR / "interim" / "uniprot_canonical_esm2_t30_embeddings.parquet"
ISOFORM_EMB_PARQUET = DATA_DIR / "interim" / "uniprot_isoform_esm2_t30_embeddings.parquet"
OUT_HEAD = DATA_DIR / "interim" / "uniprot_localization_classifier.pt"
OUT_PROBS = DATA_DIR / "interim" / "uniprot_isoform_localization_probs.tsv"
