...
Inputs:
    phase_a/data/interim/uniprot_isoform_proteins.tsv
    phase_a/data/interim/uniprot_features.tsv
    phase_a/data/interim/uniprot_entries.tsv
    phase_a/data/interim/uniprot_functional_priors.tsv (for is_kinase / is_tf)

Output:
    phase_a/data/interim/uniprot_isoform_features.tsv
"""
...
PHASE_A = Path(__file__).resolve().parents[1] / "data" / "interim"
PROT_PATH = PHASE_A / "uniprot_isoform_proteins.tsv"
ENTRY_PATH = PHASE_A / "uniprot_entries.tsv"
FEATURE_PATH = PHASE_A / "uniprot_features.tsv"
FUNCTIONAL_PATH = PHASE_A / "uniprot_functional_priors.tsv"
OUT_PATH = PHASE_A / "uniprot_isoform_features.tsv"
