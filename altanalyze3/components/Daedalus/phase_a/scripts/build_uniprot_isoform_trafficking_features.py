...
Output:
    phase_a/data/interim/uniprot_isoform_trafficking_features.tsv
"""
...
FEAT_PATH = PHASE_A / "uniprot_features.tsv"
OUT_PATH = PHASE_A / "uniprot_isoform_trafficking_features.tsv"
