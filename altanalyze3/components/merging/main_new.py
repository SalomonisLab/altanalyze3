...
class   JunctionAnnotation:
            ...
            with open(junction_dir + junction_file) as f:
                ...
                for junction in f:
                    ...
                    if junction_dict.get(start_tar_tup) != None:
                        ...
                        'gene_id':junction_dict[start_tar_tup]['gene_id'],'junction_start':junction_start}
                    ...
                    if junction_dict.get(stop_tar_tup) != None:
                        ...
                        'gene_id':junction_dict[stop_tar_tup]['gene_id'],'junction_stop':junction_stop}
    ...
    def splice_annotations(self,start_ann,stop_ann):
        annotations = {}
        annotation = start_ann['exon_region_id'] + '_' + start_ann['start']   
        return annotations
