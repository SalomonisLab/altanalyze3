...
class DataCollection:
    ...
    def sampleBEDFileAnnotation(self,gene_model_all, junction_dir, intron_dir):
        exon_dict, gene_dict,junction_dict = self.importJunctionInfo(gene_model_all)
        self.importJunctionFromBED(junction_dir, junction_dict)


    def importJunctionInfo(self,gene_model_all):
        '''
        ...
        for idx,row in gene_model_df.iterrows():
            ...
            exon_annotation = self.get_exon_annotation(row.chr,row.start,row.stop,row.exon_region_id)
    ...
    def importJunctionFromBED(self,junction_dir, junction_dict):
        '''
...
if __name__ == '__main__':
    ...
    dataCollection.sampleBEDFileAnnotation(gene_model_file, junction_dir, intron_dir)
