...
def main(gff_source, genome_fasta, ensembl_exon_dir):
    ...
    print (query_gff_file)
    cds_records, transcript_records, protein_records = isot.gff_translate(query_gff_file,genome_fasta,query_gff_file,transcript_associations_file)
